...
function Footer() {
  ...
  <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div class="text-teal-600 flex items-center space-x-3">
          <img src="Logo-my-hotel-app.png" alt="" width={100} />
          <span className='text-3xl'>EdHotel</span>
        </div>

        <p class="mt-4 max-w-xs text-gray-500"> 
         EdHotel offers unparalleled luxury and comfort, providing a sanctuary
         for travelers seeking sophistication and relaxation.
        </p>
    ...
    <p class="text-xs text-gray-500">&copy; 2024. EdHotel. All rights reserved.</p>
  </div>
</footer>
    </div>
  )
